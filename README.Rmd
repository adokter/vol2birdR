...
<details><summary>Click here for additional information when installing the dependencies on
macOS</summary>
...
You need to ensure that you follow the above three commands. The first two
...
```
See [vignette](https://adriaandokter.com/vol2birdR/articles/vol2birdR.html) for additional installation information
