...
**vol2birdR** can be used as a stand-alone package, but we recommend [bioRad](http://adokter.github.io/bioRad) as the primary user interface, with **vol2birdR** acting as a dependency of [bioRad](http://adokter.github.io/bioRad).
